...
class BinancePriceResponse:
    def __init__(self, response_data: dict):
        ...
        self.window = str(response_data.get('window', '')) if 'window' in response_data else None
        self.location = str(response_data.get('location', '')) if 'location' in response_data else None
